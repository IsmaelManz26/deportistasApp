...
<html lang="es" class="h-100" data-bs-theme="auto">
    ...
    <body class="d-flex flex-column h-100">
        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    {{ config('app.name', 'DeportistasApp') }}
                </a>
        ...
        <main class="flex-shrink-0">
            <div class="container">
                <h1 class="mt-5">Deportistas</h1>
                <p class="lead">
                    Segundo intento de aplicacion tradicional de laravel con fetch.
                </p>
                <div class="alert alert-success" role="alert" id="deportistaSuccess">Successfully done.</div>
                <div class="alert alert-danger" role="alert" id="deportistaError">Error doing.</div>
                <!-- dynamic content -->
                <div id="content"></div>
                <nav>
